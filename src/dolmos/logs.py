...
logger = logging.getLogger("dolmos")
...
logger_unique = logging.getLogger("dolmos.unique")
...
WARNINGS_BASE_URL = "https://github.com/Dowsers/dolmos/blob/main/docs/warnings.md"
