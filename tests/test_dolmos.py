...
from dolmos.__main__ import _main
from dolmos.bytevec import ByteVec
from dolmos.sevm import con
from dolmos.traces import rendered_calldata
...
def test_main(cmd, expected_path, dolmos_options):
    actual = dataclasses.asdict(_main(cmd + dolmos_options.split()))
...
def test_main_fail(cmd, dolmos_options):
    actual = dataclasses.asdict(_main(cmd + dolmos_options.split()))
